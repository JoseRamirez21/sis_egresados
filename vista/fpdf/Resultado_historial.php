...
while ($datos_reporte = $consulta_info->fetch_object()) {
   ...
   $pdf->Cell(80);
   $pdf->SetFont('Arial', 'B', 12);
   $pdf->Cell(25, 10, utf8_decode("(DATOS EXTERNOS)"), 0, 1, 'L', 0);

   $pdf->Ln(8);

   $pdf->Cell(20);
   $pdf->SetFont('Arial', 'B', 12);
   $pdf->Cell(25, 0, utf8_decode("    TRABAJO ACTUAL:"), 0, 1, 'L', 0);
   $pdf->Cell(80);
   $pdf->SetFont('Arial', '', 12);
   $pdf->Cell(25, 0, utf8_decode($datos_reporte->trabajo_actual), 0, 1, 'L', 0);
   $pdf->Cell(8);
   ...
   $pdf->Cell(20);
   $pdf->SetFont('Arial', 'B', 12);
   $pdf->Cell(25, 0, utf8_decode("                              RUC:"), 0, 1, 'L', 0);
   $pdf->Cell(80);
   $pdf->SetFont('Arial', '', 12);
   $pdf->Cell(25, 0, utf8_decode($datos_reporte->ruc), 0, 1, 'L', 0);
   $pdf->Cell(8);
   ...
   $pdf->Cell(20);
   $pdf->SetFont('Arial', 'B', 12);
   $pdf->Cell(25, 0, utf8_decode("                 UBICACION:"), 0, 1, 'L', 0);
   $pdf->Cell(80);
   $pdf->SetFont('Arial', '', 12);
   $pdf->Cell(25, 0, utf8_decode($datos_reporte->ubicacion), 0, 1, 'L', 0);
   $pdf->Cell(8);
   ...
   $pdf->Cell(20);
   $pdf->SetFont('Arial', 'B', 12);
   $pdf->Cell(25, 0, utf8_decode("                  TELEFONO:"), 0, 1, 'L', 0);
   $pdf->Cell(80);
   $pdf->SetFont('Arial', '', 12);
   $pdf->Cell(25, 0, utf8_decode($datos_reporte->telefono), 0, 1, 'L', 0);
   $pdf->Cell(8);
...
$pdf->Image('logo.png', 50, 210, 110); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
