...
<div class="page-content">
   ...
   <h4 class="text-center text-secondary pb-2">LISTA DE CONSTANCIAS REGISTRADAS</h4>

   <a class="btn btn-primary btn-rounded mb-2" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-plus-circle"></i>
      &nbsp;Registrar</a>
   <?php
   include "../modelo/conexion.php";
   include "../controlador/constancia/controlador_registrar_constancia.php";
   include "../controlador/constancia/controlador_modificar_constancia.php";
   include "../controlador/constancia/controlador_eliminar_constancia.php";
   ...
   INNER JOIN modulo ON modulo.carrera = carrera.id_carrera
   INNER JOIN constancia ON constancia.id_estudiante = estudiante.id AND constancia.id_modulo = modulo.id_modulo
      ...
      <tbody>
         ...
         while ($datos = $sql->fetch_object()) { ?>
            <tr>
               ...
               <td>
                  <img data-toggle="modal" data-target="#btnmodificarFoto<?= $datos->id_constancia ?>" style="width: 100px" src="data:image/jpg;base64,<?= base64_encode($datos->imagen) ?>" />
               </td>
               <td>
                  <a href="" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#btnmodificar<?= $datos->id_constancia ?>"><i class="fas fa-edit"></i></a>
                  <a href="constancia.php?idEliminarCer=<?= $datos->id_constancia ?>" onclick="advertencia(event)" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
               </td>
            </tr>

            <!-- Modal MODIFICAR CONSTANCIA-->
            <div class="modal fade" id="btnmodificar<?= $datos->id_constancia ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
               <div class="modal-dialog">
                  <div class="modal-content">
                     <div class="modal-header">
                        <h5 class="modal-title w-100" id="exampleModalLabel">MODIFICAR CONSTANCIA</h5>
                        ...
                        <form action="" method="POST" class="px-3">
                           <div class="row">
                              <div hidden class="fl-flex-label mb-4 px-2 col-12">
                                 <input required class="input input__text" name="txtid" value="<?= $datos->id_constancia ?>">
                              </div>
                              <?php
            ...
            <div class="modal fade" id="btnmodificarFoto<?= $datos->id_constancia ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
               <div class="modal-dialog">
                  <div class="modal-content">
                     <div class="modal-header">
                     ...
                     <div class="modal-body">
                        <form action="" method="POST" class="px-3" enctype="multipart/form-data">
                           <div class="row">
                              <div hidden class="fl-flex-label mb-4 px-2 col-12">
                                 <input type="text" class="input input__text" name="txtid" value="<?= $datos->id_constancia ?>">
                              </div>
   ...
   <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title w-100" id="exampleModalLabel">REGISTRAR CONSTANCIA</h5>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
               </button>
            </div>
            <div class="modal-body">
               <form action="" method="POST" class="px-3" enctype="multipart/form-data">
                  <div class="row">
                     ...
                     <div class="fl-flex-label mb-4 px-2 col-12">
                        <label for="">Imagen de la constancia</label>
